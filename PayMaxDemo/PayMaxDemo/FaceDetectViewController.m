...
- (IBAction)faceDetectAction:(UIButton *)sender {
    ...
    [FaceRecoSDK startFaceRecoWithViewController:self
                                            Name:self.nameTextField.text
                                        IdCardNo:self.idCardTextField.text
                                          UserId:self.userid
                                       SecretKey:@"e61489f3135f4bb09cbb54eeac70cc52"
                                     resultBlock:^(DetectResult result) {
